...
# purchaseHistory5FilePath = '../data/purchase_history_15.csv'
...
# purchase_history_5 = load_data(purchaseHistory5FilePath)
# books = load_data(booksFilePath)
#
#
# # Train the model using purchase_history_5
# def train_model(purchase_history_5):
#     global cosine_similarities, user_id_to_index, item_popularity, purchase_counts, sparse_purchase_counts
#     train_data, test_data = train_test_split(purchase_history_5, test_size=0.2, random_state=42)
...
#
#
# test_data = train_model(purchase_history_5)
#
#
