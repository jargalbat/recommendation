...
#     recalls = []
#
#     for train_index, test_index in kf.split(purchase_history):
#         train_data = purchase_history.iloc[train_index]
#         test_data = purchase_history.iloc[test_index]
#
...
#     print(f"Threshold: {threshold}, Mean Precision@5: {mean_precision:.2f}, Mean Recall@5: {mean_recall:.2f}")
#
